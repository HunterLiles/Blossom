...
static void
glad_gl_load_GL_MESA_map_buffer_client_pointer(GLADuserptrloadfunc load,
                                               void *userptr) {
  if (!GLAD_GL_MESA_map_buffer_client_pointer)
    return;
  glad_glAddClientPointerRangeMESA = (PFNGLADDCLIENTPOINTERRANGEMESAPROC)load(
      userptr, "glAddClientPointerRangeMESA");
  glad_glReleaseClientPointerRangeMESA =
      (PFNGLRELEASECLIENTPOINTERRANGEMESAPROC)load(
          userptr, "glReleaseClientPointerRangeMESA");
}
...
static int glad_gl_find_extensions_gl(void) {
  ...
  GLAD_GL_MESA_map_buffer_client_pointer =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_map_buffer_client_pointer");
